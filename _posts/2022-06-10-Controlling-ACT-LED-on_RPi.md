...
Now we know that the ACT LED is connected to GPIO pin 47 of the SoC in RPi, and enabling it will make the LED glow. The RPi B+ model uses the Broadcom BCM2835 SoC.
